...
const AGENT_ICONS = {
  ...
  code: { icon: '💻', tags: ['Qwen3-Coder-480B', '30+ Langs', 'HuggingFace'] },
  analyse: { icon: '📊', tags: ['bge-m3', 'FAISS', 'Qwen3-32B'] },
  summary: { icon: '📝', tags: ['Qwen3-32B', 'Synthesis'] },
