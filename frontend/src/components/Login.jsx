...
const PROFILE_OPTIONS = [
  { id: 'developer', name: 'Developer Suite', category: 'Engineering & IT', emoji: '💻', desc: 'Full-stack software engineering, terminal code execution & debugging', agents: ['Code', 'DevOps', 'Package Manager', 'Database', 'Search', 'Summary', 'Agent Builder', 'Visualization', 'Scraper', 'Dev Team', 'Sheets', 'Calendar', 'Notes'] },
  { id: 'cloud_devops', name: 'Cloud & DevOps SRE', category: 'Engineering & IT', emoji: '☁️', desc: 'Terraform IaC stacks, Kubernetes cluster health & CI/CD automation', agents: ['Cloud Infra', 'GitHub Workflow', 'DevOps', 'Code', 'Package Manager', 'Database', 'Search', 'Summary'] },
  { id: 'cybersec_auditor', name: 'Cybersecurity Audit', category: 'Engineering & IT', emoji: '🛡️', desc: 'CVE vulnerability audits, syslog threat triage & zero-trust compliance', agents: ['SecOps', 'Compliance', 'Code', 'Database', 'Search', 'Summary'] },
  { id: 'financial_analyst', name: 'Financial Analyst', category: 'Finance & Legal', emoji: '📈', desc: 'Executive P&L statements, cash flow projections & stock fundamentals', agents: ['Market Intelligence', 'Financial Reporting', 'Finance', 'Analyse', 'Visualization', 'Database', 'Search', 'Summary', 'Sheets'] },
  { id: 'legal_ops', name: 'Legal & HR Operations', category: 'Finance & Legal', emoji: '⚖️', desc: 'Contract NDA risk evaluation, indemnification caps & talent hiring rubrics', agents: ['Legal Contract', 'Talent Ops', 'Summary', 'Search', 'Analyse'] },
  { id: 'edtech_studio', name: 'Bharat Adaptive Learning Studio', category: 'Education & Teaching', emoji: '🇮🇳', desc: 'Teacher Executive Copilot with Google Sheets, Calendar, Notes, doc exam scanning & WhatsApp broadcasts', agents: ['Teacher Copilot', 'Doc Exam Scanner', 'Sheets Gradebook', 'Sheets', 'Calendar Scheduler', 'Calendar', 'Notes Manager', 'Notes', 'Lesson Architect', 'Exam Generator', 'WhatsApp Notices', 'Socratic Tutor', 'CCE Report Card', 'Search', 'Summary', 'Analyse'] },
  { id: 'healthcare_researcher', name: 'Medical RAG Research', category: 'Research & Growth', emoji: '🧬', desc: 'PubMed literature indexing, clinical trial phase synthesis & pharmacology', agents: ['Biomedical RAG', 'Analyse', 'Search', 'Summary', 'Translation'] },
  { id: 'creative_marketer', name: 'Growth Marketing', category: 'Research & Growth', emoji: '🚀', desc: 'SEO keyword strategies, viral ad copy hooks & production video scripts', agents: ['Marketing Campaign', 'Multimedia Processor', 'Image Gen', 'Visualization', 'Search', 'Summary'] },
  { id: 'analyst', name: 'Data Intelligence', category: 'Research & Growth', emoji: '📊', desc: 'Relational SQLite SQL operations, dynamic charts & statistical matrices', agents: ['Analyse', 'Visualization', 'Finance', 'Database', 'Search', 'Summary', 'Scraper', 'Analyst Team', 'Sheets', 'Calendar'] },
  { id: 'designer', name: 'Visual Creative Suite', category: 'Research & Growth', emoji: '🎨', desc: 'AI image generation, UI/UX mockups & high-resolution visual assets', agents: ['Image Gen', 'Visualization', 'Search', 'Summary', 'Translation'] },
  { id: 'manager', name: 'Executive Project Hub', category: 'General & Executive', emoji: '📋', desc: 'Cross-functional task delegation, automated email dispatch & calendar sync', agents: ['Calendar', 'Email', 'Notification', 'Summary', 'Search', 'Ops Team', 'Sheets', 'Notes'] },
  { id: 'guest', name: 'General AI Workstation', category: 'General & Executive', emoji: '👤', desc: 'Omni-purpose conversational AI assistant and web search exploration', agents: ['Search', 'Summary', 'Translation'] },
];
